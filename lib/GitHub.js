...
class GitHub {
    ...
    */
   constructor(auth, apiBase = 'https://api.github.com', options = {headers: {}}) {
    ...
    */
   getRepo(user, repo) {
      return new Repository(this._getFullName(user, repo), this.__auth, this.__apiBase, this.__options);
   }
